// src/components/PainPoints/PainPoints.js (VERSÃO MULTILÍNGUE)
'use client';
...
const cardIcons = [
  // Ícone 0: Lack of Financial Clarity
  ...
  // Ícone 1: Inefficient Processes / Cashflow Chaos
  ...
  // Ícone 2: Decisions Based on Hope / Apagando Incêndios
    ...
    <section id="pain-points" className={styles.painPointsSection} ref={sectionRef}>
      <div className="container">
        ...
        <div className={styles.grid}>
          {/* Mapeia os dados do dicionário em vez de dados fixos */}
